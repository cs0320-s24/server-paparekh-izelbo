...
//        logToFile(
//            "Invalid file path. Please ensure the path starts with data/ and has a .csv
// extension.");
//        System.out.println(
//            "Invalid file path. Please ensure the path starts with data/ and has a .csv
// extension.");
...
//
//  /**
//   * Prompts the user to enter a word to search for. Continuously prompts the user until a
// non-empty
...
//   * initializes the necessary objects for reading the file and performing the search, then
// executes
...
//   * @param columnToSearch The name of the column to limit the search to. An empty string
// indicates
...
//
//  /**
//   * Handles special commands entered by the user. Supports "exit" to terminate the application
// and
...
//
//  /**
//   * Logs a message to a file named "error_log.txt". The log includes the class name and line
// number
//   * from where the log method was called, along with the provided message. This method
//   * automatically appends the new log message to the end of the file, creating the file if it
// does
//   * not exist.
//   *
